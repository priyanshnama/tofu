...
- **[../README.md](../README.md)** - Main project vision and architecture (in root)
...
2. JSON Protocol: [SCHEMA.md](SCHEMA.md) - Interface specification
3. Implementation: [IMPLEMENTATION.md](IMPLEMENTATION.md) - How it's built

### For Contributors
- [COMPLETE.md](COMPLETE.md) - Full project status and capabilities
...
**Need help?** Start with [AI_USAGE.md](AI_USAGE.md) or check the main [README.md](../README.md).
